...
title: Online DDL
description: Learn how to perform non-blocking schema migrations using WeScale's Online DDL feature.
keywords: [WeScale, Online DDL, schema migration]
sidebar_position: 1
sidebar_label: Online DDL
---
